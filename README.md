...
Una vez recorridos todos los bloques de nuestro texto plano separado, se obtiene un valor de 8 bits (H6), el cual sería nuestra clave secreta con la cual se obtendrá nuestro HASH, al realizar una operación lógica XOR con nuestra llave compartida entre el emisor y el receptor. Esta llave se puede crear de manera aleatoria, siempre y cuando se comparta y tenga un formato de 8 bits. 
